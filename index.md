...
- **Ratings & metadata (CSV):** [nektar_image_ratings_n729.csv](https://github.com/floramouj/nektar/releases/download/v1.0.0/nektar_image_ratings_n729.csv)

- **All images (ZIP):** [nektar_images_n729.zip](https://github.com/floramouj/nektar/releases/download/v1.0.0/nektar_images_n729.zip)
...
The dataset contains **728 images** across the following main categories:
...
neutral           (n = 51)  
```
<em>One image, depicting a beverage in a glass with visual features consistent with both spirits and wine, was included in both category counts (485_spirits.jpg and 674_wine.jpg).</em>
